 ...
 * PAudioEngineIndex.h
 * -------------------
 * Sintesis detallada y portable del modulo AudioEngine para contexto rapido.
 *
 * Contrato base:
 ...
 *
 * Areas publicas en PAudioEngine.h:
 * - Ciclo de vida:
 ...
 * - AudioEngineDev1.cpp: bootstrap, backend, transporte y snapshots.
 * - AudioEngineDev2.cpp: render graph, mezcla, automation y PDC.
 * - AudioEngineDev3.cpp: proyecto, serializacion, undo/redo.
 * - AudioEngineDev4.cpp: plugins, sandbox, offline render y disk streaming.
 *
 * Convencion recomendada para ahorrar contexto:
 * - Compartir PProjectIndex.h + PAudioEngineIndex.h + PAudioEngineIndex.cpp como mapa general.
 * - Compartir PAudioEngine.h solo cuando haga falta tocar la API publica.
 * - Adjuntar solo AudioEngineDev<n>.cpp del area concreta a modificar.
 */
