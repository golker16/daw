 ...
 * PUI.h
 * -----
 * Contrato publico y archivo compartible del subsistema UI.
 * Si solo necesitas contexto corto para otra IA, empieza por:
 * - PProjectIndex.h
 * - PUIIndex.h
 * - PUIIndex.cpp
 *
 * Este archivo expone la API y los tipos visibles de UI.
 * La implementacion profunda vive en UIDev*.cpp y se agrega desde PUIIndex.cpp.
 */
